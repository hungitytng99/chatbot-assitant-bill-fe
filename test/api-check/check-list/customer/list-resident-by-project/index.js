...
module.exports = async function(iRequest, configs, headers, funcName) {
    ...
    const response = await iRequest(configs.APP_API + "/msx-care/api/query/v1/customer/bql-resident/findResidentByPropertyCodeAndBlock?projectId=f62c6135-0103-46ef-8907-87ba086b420d&block=", "GET", headers, {}, null, {
    });
