...
module.exports = async function(iRequest, configs, headers, funcName) {
    ...
    const response = await iRequest(configs.APP_API + "/msx-utility/api/query/v1/bql-customer/utility/getBookingService?projectId=1aa1eeed-f84d-424a-b2c6-e164a65c9366", "GET", headers, {}, null, {
    });
